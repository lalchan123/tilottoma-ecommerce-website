...
**Features-** Authentication Facility, Product add update delete and product added features are shown to the user.Users can add their preferred products to the card and from the card they can purchase products by making online based payments to purchase the products.Without authentication, users will never be able to buy and review products. You can review the product and if you want the product, you can return it within a few days.The user is provided with a nice profile facility through which he can know how many orders he has placed and see the products that have been added to the list.Admin can maintain everything from his admin dashboard. <br /> 
